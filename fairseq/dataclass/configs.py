...
@dataclass
class MaskConfig(FairseqDataclass):
    mask_regularization_type: str = field(
        default="l1",
        metadata={
            "help": "use l1 regularization for mask"
        },
    )
    mask_regularization_lambda: float = field(
        default=0.,
        metadata={"help": "mask regularization magnitude"},
    )
