...
SWEEP_NAME = "eval_6layer_iwslt_fully_weighted"
NUM_GPUS = 1
DEBUG_MODE = False
DRY_MODE = False
name_keys = []
...
OUTPUT_PATHS = [f'{TOP_LEVEL_EXPERIMENTS_FOLDER}/margsli/20220307/6layer_iwslt_fully_weighted/6layer_iwslt_fully_weighted/checkpoint_best.pt']
