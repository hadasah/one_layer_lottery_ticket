...
SWEEP_NAME = "eval_1layer_iwslt_wide_sweep"
NUM_GPUS = 1
DEBUG_MODE = False
DRY_MODE = False
name_keys = []
...
OUTPUT_PATHS = [f'{TOP_LEVEL_EXPERIMENTS_FOLDER}/margsli/20220217/1layer_iwslt_sweep/1layer_iwslt_sweep_prune-ratio={r}/checkpoint_best.pt' for r in ratios]
