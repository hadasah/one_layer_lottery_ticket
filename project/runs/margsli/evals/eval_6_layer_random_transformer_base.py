...
SWEEP_NAME = "eval_6layer_iwslt_base_sweep"
NUM_GPUS = 1
DEBUG_MODE = False
DRY_MODE = False
name_keys = []
...
OUTPUT_PATHS = [f'{TOP_LEVEL_EXPERIMENTS_FOLDER}/margsli/20220307/6layer_iwslt_base_sweep/6layer_iwslt_base_sweep_prune-ratio={r}/checkpoint_best.pt' for r in ratios]
