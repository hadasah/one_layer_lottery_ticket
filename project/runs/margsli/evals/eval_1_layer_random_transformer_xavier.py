...
SWEEP_NAME = "eval_1layer_iwslt_base_sweep_xavier"
NUM_GPUS = 1
DEBUG_MODE = False
DRY_MODE = False
name_keys = []
...
# OUTPUT_PATHS = [f'{TOP_LEVEL_EXPERIMENTS_FOLDER}/margsli/20220227/1layer_iwslt_base_sweep_xavier/1layer_iwslt_base_sweep_xavier_prune-ratio={r}/checkpoint_best.pt' for r in ratios]
OUTPUT_PATHS = [f'{TOP_LEVEL_EXPERIMENTS_FOLDER}/margsli/20220307/1layer_iwslt_base_sweep_xavier/1layer_iwslt_base_sweep_xavier_prune-ratio={r}/checkpoint_best.pt' for r in ratios]
