...
SWEEP_NAME = "eval_1layer_iwslt_base_sweep"
NUM_GPUS = 1
DEBUG_MODE = False
DRY_MODE = False
name_keys = []
...
# OUTPUT_PATHS = [f'{TOP_LEVEL_EXPERIMENTS_FOLDER}/margsli/20220218/1layer_iwslt_base_sweep/1layer_iwslt_base_sweep_prune-ratio={r}/checkpoint_best.pt' for r in ratios]
OUTPUT_PATHS = [f'{TOP_LEVEL_EXPERIMENTS_FOLDER}/margsli/20220305/1layer_iwslt_base_sweep/1layer_iwslt_base_sweep_prune-ratio={r}/checkpoint_best.pt' for r in ratios]
